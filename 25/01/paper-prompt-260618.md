...
```markdown
## <arxiv 论文标题>
[当前模型 e.g. Gemini 3.1 Pro] 一句话主要贡献或复现方法，逗号最多一个 | 👤 第一作者学校或机构, 第一作者, 通讯作者或者最后作者 | [🌐](项目网站) 搜不到就在 emoji 后加 -，空链接，后同 | [📃 <arxiv-id e.g. 2505.11917>](https://hjfy.top/arxiv/<arxiv-id>) | [✨](https://www.alphaxiv.org/abs/<arxiv-id>) | [📂](代码连接) 搜不到就 - |
<空行>
