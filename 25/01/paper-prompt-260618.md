...
```markdown
## 论文标题
[LLM 模型] 一句话主要贡献，逗号最多一个（或者一句话复现方法）[<第一机构，第一作者，通讯作者>]
<空行>
| <项目网站（如能搜到）> | https://hjfy.top/arxiv/<arxiv-id e.g. 2505.11917>  | https://www.alphaxiv.org/abs/<arxiv-id> | <github 代码连接（如能搜到）>
|-|-|-|-|
<空行>
