...
2. 期望结果
   ```
   residual x:      [4, 1024, 1280]      = 5.24M fp32 = 20 MiB
   q/k/v:           3 * [4,20,1024,64]   = 3 * 20 MiB = 60 MiB
   attention score: [4,20,1024,1024]     = 83.9M fp32 = 320 MiB
   softmax e/prob:  about 2 * 320 MiB    = 640 MiB
   FFN hidden:      several [4,1024,5120] tensors, each 80 MiB, roughly 320+ MiB
   ```
