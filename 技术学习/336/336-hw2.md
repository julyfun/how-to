...
| xl | 2560 | 10240 | 32 | 32 |: 换成了 H200
```c
(np.float64(0.37269446402788164), np.float64(0.020297942534701095))                │ a total capacity of 139.81 GiB of which 177.94 MiB is free. Process 67886 has 139.
(np.float64(1.3736595837865024), np.float64(0.020598247928436356))                 │nd 12.39 GiB is reserved by PyTorch but unallocated. If reserved but unallocated me
