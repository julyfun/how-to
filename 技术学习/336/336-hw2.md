...
(a) Add an option to your profiling script to run your model through the memory profiler. Then, run your script to get a memory profile of the xl model when either doing inference only (just forward pass) or a full training step. What do your memory timelines look like? Can you tell which stage is running based on the peaks you see?
...
full step 中 1024 peak 达到 128 peak 的 4 倍. 而 forward 仅为 1.5 倍.
