...
DAGGER:
![|400](https://how-to-1258460161.cos.ap-shanghai.myqcloud.com/how-todagger_returns_curve.png)

强制不收集新数据: `if itr == 0:` => `if itr == 0 or True:`

![|400](http://how-to-1258460161.cos.ap-shanghai.myqcloud.com/how-todagger_returns_curve.png)
