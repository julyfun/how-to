...
如果做一个跨平台 GUI，肯定要做抽象层。如果采用的是 Box<dyn Trait> 或者抽象类这种方案，就是 runtime 抽象，必然有一定性能损失。然而这些抽象如果在 comptime 做，应该可以让损失非常小，编译结束时已经消除了抽象，直接生成了平台原生代码。元编程可以做所有事情，但是开发和维护成本都很高，lsp 失效。也许 Zig 能代替元编程轻松做到代码生成，有空得玩玩。
