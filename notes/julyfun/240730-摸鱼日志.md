...
- [zed, python, lsp, works-today, remote-ssh, pixi, I-dont-know-why] Use extension Python-LSP. This works today.
```
pixi run pip install pyright
...
- to-try, todo, ok, real-machine-verified
