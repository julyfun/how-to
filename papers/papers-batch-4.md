...
相比普通 WM，本文预测的不是 video latent 而是自定义的 world embedding，training-time aux tasks 包括未来的动态区域、深度、DINO-V2 emb 等. infer-time 使用此 world emb 作为 action query 的 kv.
