...
[Gemini 3.1 Pro] UniDex 将人类视频重定向为机器人轨迹并提出统一动作空间 FAAS，训练出支持多种灵巧手的 3D VLA 模型。FTP 使用 UniDex. | 👤 清华大学, Gu Zhang, Huazhe Xu | [🌐](https://unidex-ai.github.io/) | [📃 2603.22264](https://hjfy.top/arxiv/2603.22264) | [✨](https://www.alphaxiv.org/abs/2603.22264) | [📂](https://github.com/unidex-ai/UniDex) |
...
[Gemini 3.1 Pro，] T3 提出了一个共享主干结合特定传感器编码器和特定任务解码器的       框架，用于跨多种异构触觉传感器的表示学习。 | 👤 MIT CSAIL, Jialiang Zhao, Jialiang Zhao | [🌐](https://t3.alanz.info) | [📃 2406.13640](https://hjfy.top/arxiv/2406.13640) | [✨](https://www.alphaxiv.org/abs/2406.13640) | [📂](https://t3.alanz.info) |
...
[Gemini 3.1 Pro，直接重建] GenRecon 将 3D 生成先验引入多视角重建，通过分块生成并解码为带有 PBR 材质的完整室内场景网格。 | 👤 Technical University of Munich, Katharina Schmid, Matthias Nießner | [🌐](https://kasothaphie.github.io/GenRecon/) | [📃 2605.23888](https://hjfy.top/arxiv/2605.23888) | [✨](https://www.alphaxiv.org/abs/2605.23888) | [📂](-) |
...
[Gemini 3.1 Pro，经典老番] 引入接触感知门控机制，仅在接触时激活触觉 Token 以避免干扰 | 👤 普渡 Purdue University, Kaidi Zhang, Yu She | [🌐](https://sites.google.com/view/tacvla) | [📃 2603.12665](https://hjfy.top/arxiv/2603.12665) | [✨](https://www.alphaxiv.org/abs/2603.12665) | [📂](-) |
...
[Gemini 3.1 Pro, 经典老番] 结合混合位置力控制器与推理模块，激活 VLM 先验物理知识实现触觉零样本泛化 | 👤 Tsinghua University, Jialei Huang, Yang Gao | [🌐](https://jialeihuang.github.io/tactileVLA.github.io/) | [📃 2507.09160](https://hjfy.top/arxiv/2507.09160) | [✨](https://www.alphaxiv.org/abs/2507.09160) | [📂](-) |
...
[Gemini 3.1 Pro, 一种 frame-level advantage] 利用专家轨迹中帧对的相对时间偏移作为自监督信号，训练集成模型预测帧级优势分数 | 👤 中科院自动化所, Zhihao Liu, Xinlei Chen、Chao Yu | - | [📃 2606.29834](https://hjfy.top/arxiv/2606.29834) | [✨](https://www.alphaxiv.org/abs/2606.29834) | - |
